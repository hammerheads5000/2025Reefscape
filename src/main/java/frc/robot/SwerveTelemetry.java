...
import static frc.robot.Constants.SwerveConstants.SPEED_AT_12V;
...
/**
 * Telemetry for the swerve drive from CTRE's examples
 */
public class SwerveTelemetry {
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            m_moduleSpeeds[i].setLength(state.ModuleStates[i].speedMetersPerSecond / (2 * SPEED_AT_12V.in(MetersPerSecond)));
